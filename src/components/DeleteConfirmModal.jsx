            ...
            >
              ...
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full flex items-center justify-center" style={{ background: 'rgba(220, 38, 38, 0.1)' }}>
                    <MdDelete className="text-2xl" style={{ color: '#dc2626' }} />
                  </div>
                  <div>
              ...
              <div className="flex gap-3">
                <button
                  onClick={onCancel}
                  className="btn-hover flex-1 px-4 py-2.5 font-semibold rounded-lg transition-smooth flex items-center justify-center gap-2"
                  style={{
